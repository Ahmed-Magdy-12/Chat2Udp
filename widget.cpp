    ...
    , ui(new Ui::Widget)
{
    ...
    connect(mSocket, SIGNAL(readyRead()), this, SLOT(leeSocket()));

    // PlainTextEdit
    ui->plainTextEdit->setReadOnly(true);
    ui->plainTextEdit->setStyleSheet("background-color:rgb(255,201,202");
